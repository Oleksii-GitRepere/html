...
setInterval(()=>
{
    ...
    }else if(window.screen.availWidth > 950 )
    {
        ...
        carousel_wrapper.innerHTML =  (num+1 > carousel_slides.length-1) ? (carousel_slides[carousel_slides.length-3-num] + carousel_slides[carousel_slides.length-2-num] + carousel_slides[carousel_slides.length-1-num]) : (carousel_slides[num] + carousel_slides[num+1] + carousel_slides[num+2]); //+carousel_slides[1];
    }
} 
,300);