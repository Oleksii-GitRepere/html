...
const modal_picts = [
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/dondurma.jpg" " alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/ekmek_kadayıfı.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/fırın_sutlac.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/gaziantep_baklavası.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/gullac.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/irmik_helvası.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/kabak_tatlısı.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/kazandibi.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/keskul.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/kunefe.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/lokma.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/lokum.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/mehalabiya.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/sekerpare.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/sobiyet.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/tavuk_gogsu.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/tulumba.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/asure.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/ayva_tatlısı.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/baklava.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/bal kaymak.jpg" alt="">',
    '<img style="height: 100%; width: 100%" src="img/desserts/Turkey/cezerye.jpg" alt="">'
